...
namespace OrderForm
{
    public partial class FormEdit : Form
    {
        ...
        private void btnAddItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (formItemEdit.ShowDialog() == DialogResult.OK)
                {
                    ...
                    //formItemEdit.OrderItem.GoodsItem.OrderItemID = index; //fix
        ...
        {
            //TODO 加上订单合法性验证
            CurrentOrder.OrderID = int.Parse(txtOrderId.Text);
            CurrentOrder.Customer.OrderID = CurrentOrder.OrderID;   //fix
            foreach(OrderItem oi in CurrentOrder.OrderItems)
            {
                oi.GoodsItem.Order = CurrentOrder;
                oi.GoodsItem.OrderID = CurrentOrder.OrderID;
